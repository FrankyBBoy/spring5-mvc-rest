...
public class Bootstrap implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        Customer pinouche = new Customer();
        pinouche.setFirstName("pine");
        pinouche.setLastName("nouche");
        pinouche.setCustomerUrl("url pinouche");

        customerRepository.save(bill);
        customerRepository.save(rick);
        customerRepository.save(pinouche);
    }
}
